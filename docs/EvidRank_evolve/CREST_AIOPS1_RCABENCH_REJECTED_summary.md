# EvidenceRank CREST_AIOPS1_RCABENCH_REJECTED Summary

- Created: 2026-06-08T20:39:56+08:00
- Source: `CREST_AIOPS1_RCABENCH_REJECTED`
- Algorithm: `crest`
- Dataset: `rcabench`
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| case_service | ts-cancel-service | 4 | 0.500000 | 0.500000 | 0.500000 | 0.532197 | 2 |
| fault_type | pod-failure | 24 | 0.541667 | 0.875000 | 0.875000 | 0.694273 | 3 |
| time_bucket | ts6 | 28 | 0.571429 | 0.821429 | 0.964286 | 0.718452 | 1 |
| time_bucket | ts9 | 23 | 0.608696 | 0.913043 | 0.913043 | 0.763787 | 2 |
| time_bucket | ts7 | 34 | 0.617647 | 0.794118 | 0.941176 | 0.747118 | 2 |
| fault_type | response-replace-body | 51 | 0.666667 | 0.843137 | 0.941176 | 0.776479 | 3 |
| case_service | ts-basic-service | 201 | 0.671642 | 0.870647 | 0.930348 | 0.780920 | 14 |
| fault_type | request-replace-path | 39 | 0.692308 | 0.897436 | 0.974359 | 0.816484 | 1 |
| case_service | unknown | 26 | 0.692308 | 0.884615 | 0.923077 | 0.791346 | 2 |
| fault_type | unknown | 26 | 0.692308 | 0.884615 | 0.923077 | 0.791346 | 2 |
| case_service | ts-ui-dashboard | 165 | 0.696970 | 0.921212 | 0.963636 | 0.814127 | 6 |
| case_service | ts-travel-service | 92 | 0.706522 | 0.956522 | 0.989130 | 0.832169 | 1 |
| case_service | ts-seat-service | 79 | 0.708861 | 0.974684 | 0.987342 | 0.832796 | 1 |
| fault_type | bandwidth | 42 | 0.714286 | 0.857143 | 0.880952 | 0.794459 | 5 |
| fault_type | corrupt | 46 | 0.717391 | 0.913043 | 0.956522 | 0.824482 | 2 |
| time_bucket | ts8 | 25 | 0.720000 | 0.960000 | 0.960000 | 0.831667 | 1 |
| time_bucket | ts5 | 258 | 0.728682 | 0.887597 | 0.949612 | 0.821333 | 13 |
...
| fault_type | response-replace-code | 231 | 0.740260 | 0.926407 | 0.965368 | 0.836755 | 8 |
...
| ts5-ts-cancel-service-stress-d8xbsn | ts-cancel-service | 12 | ts-consign-service|ts-food-service|ts-basic-service|ts-route-plan-service|ts-station-service | stress | ts-cancel-service |
...
| ts3-ts-consign-service-pod-failure-8cb7mp | ts-consign-service | 10 | ts-basic-service|ts-travel-service|ts-ui-dashboard|ts-food-service|ts-seat-service | pod-failure | ts-consign-service |
...
| ts5-ts-preserve-service-partition-kfrmzn | ts-preserve-service;ts-ui-dashboard | 9 | ts-seat-service|ts-contacts-service|ts-order-service|ts-notification-service|ts-food-service | partition | ts-preserve-service |
...
| ts7-ts-ui-dashboard-request-abort-mwkzh7 | ts-food-service;ts-ui-dashboard | 9 | ts-order-service|ts-seat-service|ts-consign-service|ts-contacts-service|ts-basic-service | request-abort | ts-ui-dashboard |
...
| ts2-mysql-pod-kill-xvzmxb | mysql | 8 | ts-order-service|ts-auth-service|ts-travel-service|ts-security-service|ts-preserve-service | unknown | unknown |
...
| ts1-ts-route-service-corrupt-qlt7gn | mysql;ts-route-service | 7 | ts-ui-dashboard|ts-auth-service|ts-consign-service|ts-inside-payment-service|ts-order-other-service | corrupt | ts-route-service |
| ts3-ts-basic-service-response-replace-code-ws6vpb | ts-basic-service;ts-station-service | 7 | ts-preserve-service|ts-travel-service|ts-travel2-service|ts-ui-dashboard|ts-verification-code-service | response-replace-code | ts-basic-service |
