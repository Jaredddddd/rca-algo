# EvidenceRank CREST_RESIDUAL_STRUCTURAL_ARBITRATION Summary

- Created: 2026-06-11T01:57:59+08:00
- Source: `CREST_RESIDUAL_STRUCTURAL_ARBITRATION`
- Algorithm: `crest_residual`
- Dataset: `rcabench`
...
| fault_type | pod-failure | 24 | 0.541667 | 0.875000 | 0.875000 | 0.685613 | 3 |
...
| time_bucket | ts9 | 23 | 0.695652 | 0.913043 | 0.913043 | 0.807265 | 2 |
| case_service | ts-ui-dashboard | 165 | 0.709091 | 0.915152 | 0.963636 | 0.821030 | 6 |
| fault_type | response-replace-body | 51 | 0.725490 | 0.843137 | 0.941176 | 0.809377 | 3 |
| case_service | ts-route-service | 23 | 0.739130 | 0.826087 | 0.913043 | 0.815631 | 2 |
| case_service | ts-basic-service | 201 | 0.741294 | 0.875622 | 0.930348 | 0.817874 | 14 |
| time_bucket | ts5 | 258 | 0.744186 | 0.887597 | 0.953488 | 0.830592 | 12 |
| fault_type | request-abort | 60 | 0.750000 | 0.916667 | 0.950000 | 0.839478 | 3 |
| fault_type | request-replace-method | 190 | 0.752632 | 0.926316 | 0.973684 | 0.845883 | 5 |
| fault_type | corrupt | 46 | 0.760870 | 0.913043 | 0.956522 | 0.846222 | 2 |
| case_service | ts-seat-service | 79 | 0.772152 | 0.974684 | 0.987342 | 0.860222 | 1 |
| case_service | ts-order-other-service | 27 | 0.777778 | 0.925926 | 1.000000 | 0.862346 | 0 |
| case_service | ts-consign-price-service | 9 | 0.777778 | 1.000000 | 1.000000 | 0.888889 | 0 |
| time_bucket | ts4 | 274 | 0.784672 | 0.945255 | 0.967153 | 0.863410 | 9 |
| fault_type | bandwidth | 42 | 0.785714 | 0.857143 | 0.880952 | 0.829755 | 5 |
...
| ts3-ts-consign-service-pod-failure-8cb7mp | ts-consign-service | 17 | ts-travel-service|ts-basic-service|ts-ui-dashboard|ts-food-service|ts-seat-service | pod-failure | ts-consign-service |
...
| ts3-ts-basic-service-response-replace-code-ws6vpb | ts-basic-service;ts-station-service | 7 | ts-travel-service|ts-preserve-service|ts-travel2-service|ts-travel-plan-service|ts-route-plan-service | response-replace-code | ts-basic-service |
