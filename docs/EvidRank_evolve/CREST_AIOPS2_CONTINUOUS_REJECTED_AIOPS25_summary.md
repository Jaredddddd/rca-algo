# EvidenceRank CREST_AIOPS2_CONTINUOUS_REJECTED_AIOPS25 Summary

- Created: 2026-06-08T21:28:55+08:00
- Source: `CREST_AIOPS2_CONTINUOUS_REJECTED_AIOPS25`
- Algorithm: `crest`
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| fault_type | exception | 10 | 0.000000 | 0.100000 | 0.200000 | 0.163611 | 8 |
| case_service | 0b81a605-339-cpu | 1 | 0.000000 | 0.000000 | 0.000000 | 0.166667 | 1 |
...
| case_service | 233e0282-88-cpu | 1 | 0.000000 | 0.000000 | 0.000000 | 0.142857 | 1 |
...
| case_service | 3ae307d9-218-jvm | 1 | 0.000000 | 0.000000 | 0.000000 | 0.166667 | 1 |
...
| --- | --- | ---: | --- | --- | --- |
| aiops2025-27914c5a-288-pod-failure | paymentservice | 12 | frontend|checkoutservice|cartservice|recommendationservice|shippingservice | pod-failure | 27914c5a-288 |
...
| aiops2025-6add78b2-480-cpu-stress | paymentservice | 10 | frontend|redis-cart|checkoutservice|cartservice|recommendationservice | stress | 6add78b2-480-cpu |
...
| aiops2025-68727566-367-target-port-misconfig | paymentservice | 9 | checkoutservice|frontend|cartservice|redis-cart|shippingservice | unknown | unknown |
...
| aiops2025-76222cb2-331-code-error | currencyservice | 9 | frontend|checkoutservice|cartservice|shippingservice|recommendationservice | unknown | unknown |
...
| aiops2025-91c4c773-252-jvm-cpu | adservice | 9 | cartservice|frontend|redis-cart|checkoutservice|recommendationservice | unknown | unknown |
