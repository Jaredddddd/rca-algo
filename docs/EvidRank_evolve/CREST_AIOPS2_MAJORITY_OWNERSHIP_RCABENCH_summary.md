# EvidenceRank CREST_AIOPS2_MAJORITY_OWNERSHIP_RCABENCH Summary

- Created: 2026-06-08T22:13:45+08:00
- Source: `CREST_AIOPS2_MAJORITY_OWNERSHIP_RCABENCH`
- Algorithm: `crest`
- Dataset: `rcabench`
...
| case_service | ts-basic-service | 201 | 0.691542 | 0.870647 | 0.930348 | 0.791666 | 14 |
...
| case_service | ts-ui-dashboard | 165 | 0.703030 | 0.921212 | 0.963636 | 0.816484 | 6 |
...
| fault_type | request-replace-method | 190 | 0.742105 | 0.931579 | 0.973684 | 0.841059 | 5 |
| fault_type | response-replace-code | 231 | 0.744589 | 0.926407 | 0.965368 | 0.838842 | 8 |
| fault_type | request-abort | 60 | 0.750000 | 0.916667 | 0.950000 | 0.836700 | 3 |
...
| ts3-ts-basic-service-response-replace-code-ws6vpb | ts-basic-service;ts-station-service | 8 | ts-preserve-service|ts-travel-service|ts-travel2-service|ts-ui-dashboard|ts-verification-code-service | response-replace-code | ts-basic-service |
