# EvidenceRank V10 Summary

- Created: 2026-06-02T11:23:00+08:00
- Source: `V10`
...
| time_bucket | ts6 | 28 | 0.500000 | 0.785714 | 0.964286 | 0.670238 | 1 |
| case_service | ts-cancel-service | 4 | 0.500000 | 0.500000 | 0.500000 | 0.531656 | 2 |
| time_bucket | ts7 | 34 | 0.588235 | 0.852941 | 0.882353 | 0.723109 | 4 |
...
| case_service | ts-basic-service | 201 | 0.646766 | 0.910448 | 0.980100 | 0.778181 | 4 |
...
| case_service | ts-ui-dashboard | 165 | 0.703030 | 0.890909 | 0.945455 | 0.807888 | 9 |
| case_service | ts-order-other-service | 27 | 0.703704 | 1.000000 | 1.000000 | 0.833333 | 0 |
| case_service | ts-travel2-service | 68 | 0.720588 | 0.926471 | 1.000000 | 0.827451 | 0 |
| fault_type | request-replace-method | 190 | 0.721053 | 0.894737 | 0.978947 | 0.822732 | 4 |
| fault_type | response-replace-code | 231 | 0.748918 | 0.930736 | 0.982684 | 0.842167 | 4 |
...
| ts3-mysql-pod-failure-58qts5 | mysql | 28 | ts-auth-service|ts-travel-service|ts-seat-service|loadgenerator|ts-order-other-service | pod-failure | mysql |
...
| ts1-ts-seat-service-partition-gtmt4k | ts-seat-service;ts-travel2-service | 8 | ts-order-service|ts-ui-dashboard|ts-consign-price-service|ts-travel-plan-service|ts-travel-service | partition | ts-seat-service |
...
- V10 accepted mechanism: service-local trace/metric count drop from a stable normal baseline can identify local availability/capacity loss that pure rise/endpoint evidence may miss.
- Main residual failure mechanism: pod-failure, bandwidth, request-abort, and some infrastructure-root cases still rank high-traffic or upstream services above the true local root. Count drop helps some of these but can also over-reward propagation nodes when many neighboring services lose traffic together.
- Next reusable direction: compare a service's drop evidence against parent/child/neighborhood drop patterns, suppressing global or neighborhood-wide contraction while preserving strong local disappearance.
