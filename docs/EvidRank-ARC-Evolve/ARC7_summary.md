# EvidenceRank ARC7 Summary

- Created: 2026-06-03T21:13:21+08:00
- Source: `ARC7`
...
| fault_type | bandwidth | 42 | 0.666667 | 0.857143 | 0.880952 | 0.776152 | 5 |
...
| case_service | ts-route-plan-service | 138 | 0.681159 | 0.942029 | 0.971014 | 0.809722 | 4 |
...
- ARC7 removes the older `_apply_arc_directional_contrast` reranking layer from EvidRank-ARC.
- The ablation result shows this layer had become redundant after ARC5 introduced final top-neighbor pairwise contrast. Removing it keeps AC@1, AC@3, and AC@5 unchanged, slightly improves MRR, and produces no rank regression relative to ARC6.
- Family consensus, endpoint support, robust clipping, and top-neighbor pairwise contrast remain active. Separate ablations show that removing those pieces causes meaningful accuracy loss.
